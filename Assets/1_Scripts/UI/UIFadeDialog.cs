...
public class UIFadeDialog : UIDialog
{
    ...
    public virtual void Open(eSTATE _state, UnityEngine.Events.UnityAction _complete, float _duration)
    {
        ...
        PUtil.UIUtil.SetAlpha(image, m_state == eSTATE.FADE_IN ? 0f : 1f);
    }
    ...
    public override void UpdateLogic()
    {
        ...
        {
            PUtil.UIUtil.SetAlpha(image, curve.Evaluate(m_time));
        }
        else
        {
            PUtil.UIUtil.SetAlpha(image, 1f - curve.Evaluate(m_time));
        }
